...
**Generated from 28 test runs across 5 tools.**

> Legend: ✅ PASS  ❌ FAIL  ➖ N/A (not applicable to this mode)

> sim = simulation  |  synth = synthesis (only features expected to synthesize)

| Feature | Standard | Category | Altera<br>ModelSim<br>Starter<br>2020.1<br>(sim) | Altera<br>Questa<br>Starter<br>2025.3<br>(sim) | Vivado<br>2023.2<br>(sim) | Vivado<br>2023.2<br>(synth) |
|---------|----------|----------|---|---|---|---|
| **VHDL-2000** | | |||||
