...
| [Interface mode views — per-field direction control on composite types](https://github.com/baverrud/vhdl-compat/blob/main/tests/vhdl2019/interfaces/interfaces_lcs045a_mode_view.vhd) | VHDL-2019 | ✅ | ❌ | Simulation only |
