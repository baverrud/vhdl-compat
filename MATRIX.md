...
**Generated from 6 test runs across 5 tools.**
...
| Feature | Category | Altera<br>ModelSim<br>Starter<br>modelsim<br>(sim) | Altera<br>Questa<br>Starter<br>questa<br>(sim) | Vivado<br>2023.2<br>(sim) | Vivado<br>vivado<br>(sim) | Vivado<br>2023.2<br>(synth) | Vivado<br>2026.1<br>(synth) |
|---------|----------|---|---|---|---|---|---|
| **VHDL-2000** | |||||||
...
| Feature | Standard | Altera<br>ModelSim<br>Starter<br>modelsim<br>(sim) | Altera<br>Questa<br>Starter<br>questa<br>(sim) | Vivado<br>2023.2<br>(sim) | Vivado<br>vivado<br>(sim) | Description |
|---------|----------|---|---|---|---|-----------|
