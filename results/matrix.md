...
Each row shows whether the tool correctly enforces standard boundaries.
A test should **pass** in older standards (code was legal) and **fail** in newer standards (code became illegal).

| Feature | Break Reason | VHDL-2000 | VHDL-2002 | VHDL-2008 | VHDL-2019 |
|---------|-------------|---|---|---|---|
| Predefined functions to_string, minimum, maximum clash with user code | Correctly rejected in VHDL-2019:  | ✅ | ✅ | ❌ | ✅ |
| New VHDL-93 reserved keywords (shared, xnor, etc.) | Correctly rejected in VHDL-2000: ** Error: C:\proj\rune\fpga\vhdl-compatibility\ | ✅ | ✅ | ✅ | ✅ |
| Reserved keyword "context" -- breaks VHDL-93 identifiers named "context" | Correctly rejected in VHDL-2008: ** Error: C:\proj\rune\fpga\vhdl-compatibility\ | ✅ | ✅ | ✅ | ✅ |
| Reserved keyword "view" -- breaks VHDL-2008 identifiers named "view" | Correctly rejected in VHDL-2019:  | ✅ | ✅ | ✅ | ✅ |
| Shared variables must be of protected type | Correctly rejected in VHDL-2019:  | ❌ | ❌ | ❌ | ✅ |
| File declaration syntax changed from VHDL-87 | Correctly rejected in VHDL-2019:  | ❌ | ❌ | ❌ | ✅ |
| std_logic_vector redefined as subtype of std_ulogic_vector | Should compile in VHDL-2000: ** Error: C:\proj\rune\fpga\vhdl-compatibility\test | ❌ | ❌ | ✅ | ✅ |
| Predefined functions to_string, minimum, maximum clash with user code | Correctly rejected in VHDL-2019:  | ✅ | ✅ | ❌ | ✅ |
| New VHDL-93 reserved keywords (shared, xnor, etc.) | Correctly rejected in VHDL-2000: ** Error: C:\proj\rune\fpga\vhdl-compatibility\ | ✅ | ✅ | ✅ | ✅ |
| Reserved keyword "context" -- breaks VHDL-93 identifiers named "context" | Correctly rejected in VHDL-2008: ** Error: C:\proj\rune\fpga\vhdl-compatibility\ | ✅ | ✅ | ✅ | ✅ |
| Reserved keyword "view" -- breaks VHDL-2008 identifiers named "view" | Correctly rejected in VHDL-2019:  | ✅ | ✅ | ✅ | ✅ |
